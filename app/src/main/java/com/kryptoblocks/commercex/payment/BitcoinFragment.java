...
public class BitcoinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //  bit_back_btn = view.findViewById(R.id.bitcoin_backbtn);
        toolbar_bitcoin = view.findViewById(R.id.toolbar_bit);
        /*bit_back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
